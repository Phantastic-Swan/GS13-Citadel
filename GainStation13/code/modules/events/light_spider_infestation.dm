/datum/round_event_control/spider_infestation/light
	name = "Light Spider Infestation"
	typepath = /datum/round_event/spider_infestation/light
	weight = 7
	max_occurrences = 4
	min_players = 8
...
/datum/round_event/spider_infestation/light/start()
	...
	while((spawncount >= 1) && vents.len)
		...
		var/spawn_type = /obj/structure/spider/spiderling/regular
